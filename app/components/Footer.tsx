  ...
  return (
    ...
    <footer className="relative pt-90 ">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 -mb-50">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-100/50 overflow-hidden relative">
          ...
          <div className="relative bg-white rounded-3xl p-8 lg:p-12">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-[#1e3a5f]/30 to-transparent"></div>
          </div>
        </div>
